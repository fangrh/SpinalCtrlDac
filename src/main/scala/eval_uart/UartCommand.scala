...
class UartCommand(clockDivide : Int=6, dataWidth : Int=24, niCtrl:Boolean=false, logo : Char = ')') extends Component {
  ...
  val delayFsm = new StateMachine{
    ...
    val totalCount = Math.pow(2, 20).toInt
...
//                                                  targetDirectory="../GenTwoPulse/src")
